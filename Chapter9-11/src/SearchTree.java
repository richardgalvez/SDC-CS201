// Chapter 11, Lesson 6 - Binary Search Tree Practical Application Excercise
...
public class SearchTree {
    ...
    // Find method asking for node to find
    ...
    public static void main(String[] args) {
        ...
        for (int i = 1; i <= 10; i++) {
            System.out.print("Please enter value " + i + " for the tree: ");
